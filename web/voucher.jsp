...
<html lang="en">
    ...
    <body>
        ...
        <div class="fables-header fables-after-overlay">
            <div class="container"> 
                <h2 class="fables-page-title fables-second-border-color">Vouchers</h2>
            </div>
        </div>
                ...
                <div class="col-md-6">
                    <form action="#" method="get" class="position-relative">
                        <div class="input-group">
                            <input name="searchOrderId" value="" class="form-control border-secondary py-3 rounded-start" type="text" placeholder="Enter what you want to find">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <c:forEach items="${lstVoucher}" var="v">
                                <tr>
                                    <td>${v.productName}</td>
                                    <td>${v.code}</td>
                                    <td>${v.name}</td>
