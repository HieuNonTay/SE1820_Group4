<%-- 
    Document   : footerShoesShop
    Created on : 31 thg 5, 2024, 13:52:23
    Author     : DELL
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                        <a href="#" class="fables-second-border-color border-bottom pb-3 d-block mb-3 mt-minus-13"><img src="assets/custom/images/Logo-header1.jpg" alt="fables template"></a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <h2 class="font-20 semi-font fables-second-border-color border-bottom pb-3 mb-3">Information</h2>
